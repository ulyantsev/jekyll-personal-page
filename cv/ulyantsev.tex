...
Born in 1990 in St.~Petersburg, Russia. I have been really into math and programming since early childhood.
...
In 2010 started a research career with developing new evolutionary and SAT-based methods for solving NP-hard problem' instances.
Defended PhD on automata synthesis using SAT and CSP solvers in 2015.
Also since 2014 developing tools for metagenomic WGS analysis in collaboration with Moscow colleagues.
\smallskip

In parallel with a research career, established as a leader and supervisor. 
Since 2012 participated in grants fundraising and leading projects. 
After defending PhD in 2016 become a leader of joint ITMO-JetBrains Research lab, 12~members on top. 
Since 2017 became the whole Computer Technologies Lab leader, extanded the Lab to 7 groups, 130 members on top.
\smallskip

More detailed bio available here: \url{https://ulyantsev.com/bio/}.
\smallskip

\emph{Personal values}: independence, ambition, logic, responsibility.

\emph{Hobbies}: swimming, skiing, surfing, singing, texas holdem.
...
\cventry{Sep 2016--now}{associate professor}{\itmo, Information Technologies and Programming Faculty}{}{}
        {supervising BS, MS \& PhD students, leading projects on CS, ML \& bioinformatics}
...
\cventry{Mar 2008--Mar 2010}{programming contests organization stuff}{\itmo, Information Technologies and Programming Faculty}{}{}{}
...
\cventry{2011--2013}{Master degree in Applied Mathematics and Informatics}{\itmo }{Saint Petersburg, Russia}
        {}{Information Technologies and Programming Faculty, Computer Technologies Department}
\cventry{2007--2011}{Bachelor degree in Applied Mathematics and Informatics}{\itmo }{Saint Petersburg, Russia}
        {}{Information Technologies and Programming Faculty, Computer Technologies Department}

\section{Software}

\cventry{2014--now}{developer, algorithms designer, teamlead}{MetaFast}{\url{https://github.com/ctlab/metafast}}
        {}{METAgenome FAST analysis toolkit for feature extraction and calculating a number of statistics of metagenome sequences}
\cventry{2016--now}{teamlead, algorithms designer}{MetaCherchant}{\url{https://github.com/ctlab/metacherchant}}
        {}{tool for analysing genomic environment of a nucleotide sequence within a metagenome}
\cventry{2018--now}{teamlead, algorithms designer}{RECAST}{\url{https://github.com/ctlab/RECAST}}
...
\cventry{2017--now}{optimization algorithms part supervisor}{GADMA}{\url{https://github.com/ctlab/GADMA}}
        {}{tool for automatic inference of the joint demographic history of multiple populations from the genetic data}
\cventry{2010--2019}{developer, algorithms designer, teamlead}{EFSM-tools}{\url{https://github.com/ctlab/EFSM-tools}}
...
\cvitem{2021}{Ivanov Artem (MS)}
\cvitem{2020}{Zakirzyanov Ilya (PhD), Pavlenko Artem (MS), Zvyagintseva Darya (BS)}
\cvitem{2019}{Ivanov Artem (BS), Melnikov Roman (BS)}
\cvitem{2018}{Noskova Ekaterina (MS), Pavleko Artem (BS)}
\cvitem{2017}{Zakirzyanov Ilya (MS), Moklev Vyacheslav (BS), Kachalsky Ilya (BS)}
\cvitem{2016}{Vasilyev Artem (MS)}
\cvitem{2015}{Zakirzyanov Ilya (BS), Melnik Mikhail (BS)}
...
\begin{itemize}
  ...
  \item In 2019 took part in a standup show, joking aroud scientific mindset
  \item Starting 2018 actively serving in ITMO University' councils, doing my best to evolve internal policies
\end{itemize}
